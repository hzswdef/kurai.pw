...
DISCORD_BEATMAPS_UPDATES_WEBHOOK = os.environ["DISCORD_BEATMAPS_UPDATES_WEBHOOK"]
DISCORD_BEATMAPS_REQUESTS_WEBHOOK = os.environ["DISCORD_BEATMAPS_REQUESTS_WEBHOOK"]
